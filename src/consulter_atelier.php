...
$query3= " SELECT num_reservation,nom_atelier,reservation_date,reservation_heure,dure,etat from reservation_atelier where etat='en cours'             ";
//die(print_r($query2));
...
$query30= "      UPDATE reservation_atelier
...
<h2> RESERVATION D'ATELIER </h2></br></br>
<table class="table">
  <thead>
    <tr>
    <th scope="col">#</th>
