...
elseif(empty($dure)){
	...
	$query5="SELECT * from reservation_salle where reservation_date="."'".$date."'"." && reservation_heure="."'".$heure."'"." && nom_salle="."'".$salle."'"."    ";
//die(print_r($query5));
...
}else{$query3="INSERT INTO reservation_salle (CNE,reservation_date,reservation_heure,nom_salle,dure) values("."'".$CNE."'".","."'".$date."'".","."'".$heure."'".","."'".$salle."'".",  "."'".$dure."'"." )           ";
	//die(print_r($query3));
...
if(isset($_POST['submit2'])){
	$date=htmlentities(trim($_POST['date']));
$query4= " SELECT nom_salle,reservation_date,reservation_heure,dure from reservation_salle where reservation_date >= "."'".$date."'"." && reservation_date <= ADDDATE("."'".$date."'".",7);  ";
//die(print_r($query4));
