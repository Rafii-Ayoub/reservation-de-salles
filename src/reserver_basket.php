...
$query2="SELECT * from reservation_t where reservation_date="."'".$date."'"." && reservation_heure="."'".$heure."'"." && nom_t="."'".$terrain."'"."    ";
...
if($res==1){
	...
	$query3="INSERT INTO reservation_t (CNE,reservation_date,reservation_heure,nom_t,dure) values("."'".$CNE."'".","."'".$date."'".","."'".$heure."'".","."'".$terrain."'".","."'".$dure."'"." )    ;       ";
	//die(print_r($query3));
...
if(isset($_POST['submit2'])){
	$date=htmlentities(trim($_POST['date']));
$query4= " SELECT nom_t,reservation_date,reservation_heure,dure,num_reservation from reservation_t where reservation_date >= "."'".$date."'"." && reservation_date <= ADDDATE("."'".$date."'".",7);  ";
//die(print_r($query4));
...
<html>
<head>
	<title>Formulaire TerrainF</title>
