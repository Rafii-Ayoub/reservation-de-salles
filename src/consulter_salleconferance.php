...
$query5= " SELECT nom_salleConferance,reservation_date,reservation_heured,reservation_heuref,description,etat from reserversalleconferance where etat='en cours'              ";
//die(print_r($query2));
...
$query50= "      UPDATE reservationsalleconferance
...
<p2> RESERVATION DE SALLE DE CONFERANCE </p2></br></br>
<table class="table">
  <thead>
    <tr>
